...
parser.add_argument('--trainData', default='DIV2K', help='train dataset name')
parser.add_argument('--load', default= 'model_name', help='save model')

parser.add_argument('--model_name', default= 'IDN', help='model to select')
...
parser.add_argument('--nFeat_slice', type=int, default=4,  help='scale of slice feature')
